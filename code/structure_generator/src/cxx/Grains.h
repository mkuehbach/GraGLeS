...
struct myPreferenceOri {
	...
	myPreferenceOri(myQuaternion _ori) { //preference orientation identifying default properties for all grains far away from all distinguished preference orientations
		ori = _ori;
